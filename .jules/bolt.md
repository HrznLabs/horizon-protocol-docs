...
## 2025-03-30 - Unnecessary React.memo() on Static Components
...
**Action:** Only use `React.memo()` for expensive components that actually receive new props frequently or whose parent components re-render often.
