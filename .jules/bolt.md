...
## 2025-03-12 - Unnecessary React.memo() overhead
...
**Action:** Only apply `React.memo()` to components where the parent component frequently re-renders and the child component's props remain stable. Do not use it for static components or components inside stateless parents.
