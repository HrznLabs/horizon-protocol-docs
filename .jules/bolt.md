...
## 2025-03-27 - Unnecessary React.memo() overhead
...
**Action:** Only use `React.memo()` when a component is likely to receive the same props and its parent renders frequently.
