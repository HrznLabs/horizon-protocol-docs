...
// ⚡ Bolt: Removed unnecessary memo() from static component in a stateless tree
...
// CopyButton keeps memo() because it has internal state, but its props don't change often.
