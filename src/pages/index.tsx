...
const HomepageHeader = function HomepageHeader() {
...
const QuickLinks = function QuickLinks(): ReactNode {
  return (
...
const CopyButton = function CopyButton({text}: {text: string}) {
...
const ExternalLinkIcon = function ExternalLinkIcon({size = 12, className}: {size?: number, className?: string}) {
  return (
...
const ArrowRightIcon = function ArrowRightIcon({size = 16, className}: {size?: number, className?: string}) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const Deployments = function Deployments(): ReactNode {
  return (
