...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'v2_1_launch',
      content:
        '<span aria-hidden="true">🚀</span> Horizon Protocol Core v2.2 + Token M5 is now live on Base Sepolia! <a href="/docs/guides/getting-started" aria-label="Get started with Horizon Protocol">Get started →</a>',
