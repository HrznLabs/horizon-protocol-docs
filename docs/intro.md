...
{/* ⚡ Bolt: Replaced raw <a> tags with Docusaurus <Link> components to enable client-side routing, preventing full page reloads and significantly improving navigation speed. */}
<div className="row">
