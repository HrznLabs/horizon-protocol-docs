  ...
  <div className="col col--6">
    <div className="card margin-bottom--lg">
      ...
      <div className="card__footer">
        {/* ⚡ Bolt: Replaced raw HTML <a> tag with Docusaurus <Link> component to enable client-side routing. This prevents full page reloads and significantly improves navigation performance. */}
