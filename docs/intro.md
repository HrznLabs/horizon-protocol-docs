  ...
  <div className="col col--6">
    <div className="card margin-bottom--lg">
      ...
      <div className="card__footer">
        {/* ⚡ Bolt: Replaced standard <a> tags with Docusaurus <Link> component to enable client-side routing. This prevents full page reloads on internal navigation, significantly improving perceived performance and reducing server load. */}
